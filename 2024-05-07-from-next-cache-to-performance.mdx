...
tags:
  - 缓存
  - 性能
abstract: '早在我写 Android 客户端的时候就考虑过数据持久化问题，于是我一直在想一套完善的缓存方案究竟是怎样的，这其实有关软件中数据流向的设计。Next.js Doc 里从宏观上介绍了其缓存的设计，作为一个全栈框架，我们可以一探究竟，看看其是如何在性能、开发难度和资源消耗中找到平衡点的...'
---
...
![Caching Overview](/images/2024-05-07-from-next-cache-to-performance/caching-overview.webp)
