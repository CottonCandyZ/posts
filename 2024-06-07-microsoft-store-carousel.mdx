...
tags:
  - 动画
abstract: 最近在边学边做 Bangumi 的 Electron 客户端，于是就想着 UI 得参考一些现有的 App，于是我盯上了 Microsoft Sore。它的轮播图好漂亮！我要拿过来...
---
...
很头大，首先我们来实现基本的动画，这里我不想折磨自己了，直接用 Framer Motion 吧（我花了亿点点时间研究一下这个库，它看上去完全可以实现我想要的功能）
...
到了激动人心的时刻，让我们来欣赏以下实现的结果，可以看到不再会卡顿，且非常的流畅的说！
