...
![WebAuthn 注册过程](/images/WebAuthn注册过程.png)
...
注意到表里有个奇怪的东西 `aaguid`，我后面会说这是用来干嘛的。
...
![webAuthn 验证过程](/images/WebAuthn验证过程.png)
